...
module.exports = {
SESSION_ID: process.env.SESSION_ID || ' VAJIRA-MD=aNlBza4I#8QimDcVGTpcpC4zj8hr-kepQhOMk20xb-UfTpExhN5Q' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "923265705626,923265705626" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'HIRA' ,
